...
//
// adminInterestsH, adminSubscribersH, and adminSuppressionsH may be nil (dev
...
func mountAndServe(
	...
	for _, r := range adminRoutes(settingsH, adminUsersH, adminAuditH, adminInterestsH, adminSubscribersH, adminSuppressionsH) {
