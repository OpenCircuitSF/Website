-- Open Circuit SF — development teardown
--
...
--
-- WARNING: This permanently destroys all data in the `opencircuit` database.
...
DROP DATABASE IF EXISTS opencircuit;

-- Drop the application login role.
DROP ROLE IF EXISTS opencircuit;
